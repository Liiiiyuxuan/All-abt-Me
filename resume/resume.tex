...
\resumeSubHeadingListStart
    ...
    {Honours Computer Science, Co-operative Program}{Aug. 2023 -- May 2027}
...
\section{Projects}
    ...
    %     \resumeItemListEnd
    \resumeProjectHeading
        {\textbf{Flappy Bird Game} $|$ \emph{Python, PyGame}}{May. 2022 - Jun. 2022}
        \resumeItemListStart
        ...
        \resumeItemListEnd
    \resumeProjectHeading
        {\textbf{Chess Game} $|$ \emph{JavaScript, p5.js}}{Nov. 2022 - Dec. 2022}
        \resumeItemListStart
        ...
        \resumeItemListEnd
    \resumeProjectHeading
        {\textbf{Maze Generator} $|$ \emph{JavaScript, p5.js}}{Oct. 2022 - Nov. 2022}
        \resumeItemListStart
        ...
        \resumeItemListEnd
    \resumeProjectHeading
        {\textbf{The White Board} $|$ \emph{HTML, JavaScript, CSS, Tailwind, MongoDB}}{Oct. 2022 - Present}
        \resumeItemListStart
            \resumeItem{Online learning platform.}
            \resumeItem{We are still working on this!}
        \resumeItemListEnd
    \resumeSubHeadingListEnd
